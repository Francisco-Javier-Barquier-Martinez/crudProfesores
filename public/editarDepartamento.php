...
?>
    ...
    <head>
        ...
        <title>Departamentos | Editar Departamento</title>
    </head>
    ...
    <body style="background-color:bisque">
        ...
        <div class="container mt-3">
            <form name="nt" action="<?php echo $_SERVER['PHP_SELF'] . "?id=$id"; ?>" method="POST">
                <div class="mt-2">
                    <input type="text" name="nombre" required value="<?php echo $fila->nom_dep; ?>" class="form-control" />
                </div>
                <div class="mt-2">
